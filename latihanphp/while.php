...
//   var_dump($members);
// $num = 0;
// while ($num < sizeof($members)) {
//     echo "ID : ".$members [$num]["id"]."\n";
//     echo "Name : ".$members [$num]["name"]."\n";
//     echo "Address : ".$members [$num]["address"]."\n";
//     echo "Status warga : ".$members [$num]["status_warga"]."\n";
//     echo "Created at : ".$members [$num]["created_at"]."\n";
//     echo "Update at : ".$members [$num]["updated_at"]."\n";
//     echo "\n";
//     $num++;
// }
 ?>